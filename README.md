# Sys Web Browser Eternos ORG - versão: 1.0.0.32
...
* [Baixar Versão com instalador](http://eternosorg.com/weblurk)
...
* Abra a pasta  e seleciona `Eternosweblurk10032p.exe` e pressione `enter` para execultar
